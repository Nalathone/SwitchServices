...
export default {
  setup() {
    ...
    const sendRequest = (wallet, value) => {
      const url = `http://172.21.25.79:7007/jdb/v1/disableenablewalletaccount?sign=ed0e999dda8e923cb1eaa402384213a3439db0fe556e68ba24a8a985947f14dd&PROVIDER_CODE=${wallet[0]}&PROVIDER_STATUS=${value}`;
      axios
        .post(url)
        .then((response) => {
    ...
    onMounted(async () => {
      ...
      const response = await axios.post(
        "http://172.21.25.79:7007/jdb/v1/displaywalletaccount?sign=ed0e999dda8e923cb1eaa402384213a3439db0fe556e68ba24a8a985947f14dd"
      );
