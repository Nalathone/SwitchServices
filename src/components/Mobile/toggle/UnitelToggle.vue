  ...
  export default {
    data() {
      return {
        value: false,
        status: 'Off',
        apiUrlOn: 'http://172.21.57.211:8080/jdb/v1/mobiledisable?sign=ed0e999dda8e923cb1eaa402384213a3439db0fe556e68ba24a8a985947f14dd&BILLER_CODE=UNT&status=O', // replace with your API URL to turn on
        apiUrlOff: 'http://172.21.57.211:8080/jdb/v1/mobiledisable?sign=ed0e999dda8e923cb1eaa402384213a3439db0fe556e68ba24a8a985947f14dd&BILLER_CODE=UNT&status=C' // replace with your API URL to turn off
      }
    },
    mounted() {
